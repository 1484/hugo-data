...
LogitechのKEYS-TO-GO2と言うキーボードをご存知でしょうか。とても薄く重量も222gと軽く持ち運びに便利なモバイルキーボードです。
...
そんなこともありUS配列モデルを買いたかったのですが国内では発売していません。ちなみに「１」の方には日本語配列の設定はなくUS配列のみの発売です。「２」にも当然US配列版もあるので持ってきて日本でも売ってくれるだけで良いのですが何故出来ないのでしょう。。。
